...
public class SelectCityAdapter extends RecyclerView.Adapter<SelectCityAdapter.InsertCategoryHolder> {
    private static final String TAG = SelectCityAdapter.class.getCanonicalName();
    ...
    public SelectCityAdapter(Context context) {
        ...
        mCityList = new ArrayList<>(Arrays.asList(context.getResources().getStringArray(R.array.cities)));
    }
